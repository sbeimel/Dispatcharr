...
const FeatureToggles = ({ settings, onSave }) => {
  // multi_mac_rotation_enabled removed - redundant with mac_failover_enabled in Account Failover settings
    ...
    <Stack gap="md">
      ...
      <Paper withBorder p="md">
        ...
        <Text size="xs" c="dimmed" mt="sm">
          Note: MAC/Profile failover is configured in Account Failover settings.
        </Text>
      </Paper>
