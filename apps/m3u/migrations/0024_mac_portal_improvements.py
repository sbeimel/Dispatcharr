...
class Migration(migrations.Migration):
    ...
    operations = [
        # M3UAccountMac Model - MUST be created FIRST before any ForeignKeys reference it
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=['account', 'address'], name='unique_account_mac_address'),
        ),
